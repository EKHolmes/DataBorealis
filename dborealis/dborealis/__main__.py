  ...
  def insert(self, val, param):
    ...
    if val == "nvp":
      if dbl[-1] != "":
        ...
        content = "nvp;" + param + "\n"
      if "=" not in param:
        print("Borealis Error: Invalid Parameter")
      else:
        dbw.write(content)
        dbr = open(file_name, "r")
        dbl = dbr.readlines()
...
def help():
  ...
  print("For more information, visit https://repl.it/@ekholmes/DBorealis or https://github.com/EKHolmes/DBorealis.")
